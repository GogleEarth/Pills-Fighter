...
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "GSMinimapSight", "gs_5_1", ppd3dShaderBlob));
}
...
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSMinimapTerrain", "ps_5_1", ppd3dShaderBlob));
}
D3D12_SHADER_BYTECODE CMinimapShader::CreatePixelShaderMinimapSight(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSMinimapSight", "ps_5_1", ppd3dShaderBlob));
}
