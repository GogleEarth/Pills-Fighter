...
void CLobbyScene::JoinPlayer(int nServerIndex, const char *pstrPlayerName)
{
	...
	m_ppTextObjects[nServerIndex] = AddText("휴먼매직체", pstrPlayerName, xmf2Pos, XMFLOAT2(0.8f, 0.8f), XMFLOAT2(1.0f, 1.0f), xmf4Color);
}
...
void CLobbyScene::LeavePlayer(int nServerIndex)
{
	...
	for (auto& playerinfo : m_umPlayerInfo)
	{
		...
		ChangeText(m_ppTextObjects[nServerIndex], "휴먼매직체", m_ppTextObjects[nServerIndex]->GetText(), xmf2Pos, XMFLOAT2(0.8f, 0.8f), XMFLOAT2(1.0f, 1.0f), xmf4Color);
	}
}
