...
CMinimapRobotRect::CMinimapRobotRect(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, XMFLOAT2 xmf2Center, XMFLOAT2 xmf2Size) : CMesh(pd3dDevice, pd3dCommandList)
{
	m_nOffset = 0;
	m_nSlot = 0;
	m_d3dPrimitiveTopology = D3D_PRIMITIVE_TOPOLOGY_POINTLIST;
...
void CMinimapRobotRect::OnPreRender(ID3D12GraphicsCommandList *pd3dCommandList)
{
	D3D12_VERTEX_BUFFER_VIEW pVertexBufferViews[3] = { m_d3dPositionBufferView, m_d3dSizeBufferView, m_d3dIndexBufferView };
